export default function handler(_request, response) {
  ...
  response.status(200).json({
    ...
    contract: {
      ...
      deployTxHash: "pending-basescan-copy",
      firstRecordTxHash: null,
      ...
      sourcePath: "contracts/LaunchWorkflowProofV3.sol",
      purpose: "Founder-owned contract for AI workflow receipt hashes, metadata URI, readiness score, risk code, and agent operator proof on Base mainnet.",
      firstRecordStatus: "pending owner or agentOperator signature",
    },
    agentSteps: [
      {
        id: "wallet-status",
